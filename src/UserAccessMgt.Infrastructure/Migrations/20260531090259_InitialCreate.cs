        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignationNameEN = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    DesignationNameBN = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DivisionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DivisionNameEN = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DivisionNameBN = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeNameEN = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    GradeNameBN = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Weekends_DayOfWeek", "[DayOfWeek] BETWEEN 0 AND 6");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DistrictId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DistrictNameEN = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DistrictNameBN = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DivisionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ThanaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ThanaNameEN = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ThanaNameBN = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DistrictId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstituteNameEN = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    InstituteNameBN = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LatitudeLongitude = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Institutes_Thanas_ThanaId",
                        column: x => x.ThanaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_MobileNumber_BD", "[MobileNumber] LIKE '01[3-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInLatitudeLongitude = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CheckOutLatitudeLongitude = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Institute administrator", "InstituteAdmin" },
                    { 3, "Regular user", "User" }
                });
